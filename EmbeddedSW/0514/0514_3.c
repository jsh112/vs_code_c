...
#define OSPEEDR_A 0x0C000000U
#define OSPEEDR_B 0x000000C0U
...
void print129(){
    // 1 -> b, c
    *((V_UINT32 *)(GPIOG | BSRR)) |= 0x01 << 6;
    *((V_UINT32 *)(GPIOG | BSRR)) |= 0x01 << (7 + 16);
    *((V_UINT32 *)(GPIOF | BSRR)) |= 0x01 << (9 + 16);
    *((V_UINT32 *)(GPIOF | BSRR)) |= 0x01 << 10;
    *((V_UINT32 *)(GPIOC | BSRR)) |= (0x01 << 1);
    *((V_UINT32 *)(GPIOC | BSRR)) |= (0x01 << 2);
    *((V_UINT32 *)(GPIOC | BSRR)) |= (0x01 << 6);
    delay(300);
    *((V_UINT32 *)(GPIOG | BSRR)) |= 0x01 << (7 + 16);
    *((V_UINT32 *)(GPIOF | BSRR)) |= 0x01 << (9 + 16);
    delay(300);
    // 2 -> a, b, d, e, g
    *((V_UINT32 *)(GPIOG | BSRR)) |= 0x01 << (6 + 16);
    *((V_UINT32 *)(GPIOG | BSRR)) |= 0x01 << (7 + 16);
    *((V_UINT32 *)(GPIOF | BSRR)) |= 0x01 << 9;
    *((V_UINT32 *)(GPIOF | BSRR)) |= 0x01 << (10 + 16);
    *((V_UINT32 *)(GPIOC | BSRR)) |= 0x01 << (1 + 16);
    *((V_UINT32 *)(GPIOC | BSRR)) |= 0x01 << 2;
    *((V_UINT32 *)(GPIOC | BSRR)) |= 0x01 << (6 + 16);
    delay(300);
    *((V_UINT32 *)(GPIOG | BSRR)) |= 0x01 << (6);
    *((V_UINT32 *)(GPIOG | BSRR)) |= 0x01 << (7);
    *((V_UINT32 *)(GPIOF | BSRR)) |= 0x01 << (10);
    *((V_UINT32 *)(GPIOC | BSRR)) |= 0x01 << (1);
    *((V_UINT32 *)(GPIOC | BSRR)) |= 0x01 << (6);
    delay(300);
...
int main()
{
    ...
    *((V_UINT32 *)(GPIOF | BSRR)) |= 0x01 << 10 | 0x01 << 9;
	...
	// PC 1, 2, 6 e,f,g
    *((V_UINT32 *)(GPIOC | MODER)) |= (0x01 << 2 * 1) | (0x01 << 2 * 2) | (0x01 << 2 * 6);
    *((V_UINT32 *)(GPIOC | OSPEEDR)) |= (0x03 << 2 * 1) | (0x03 << 2 * 2) | (0x03 << 2 * 6);
    *((V_UINT32 *)(GPIOC | PUPDR)) |= (0x01 << 2 * 1) | (0x01 << 2 * 2) | (0x01 << 2 * 6);
    *((V_UINT32 *)(GPIOC | BSRR)) |= (0x01 << 1) | (0x01 << 2) | (0x01 << 6);
