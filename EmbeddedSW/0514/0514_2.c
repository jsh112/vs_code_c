...
int main()
{
    ...
    *((V_UINT32 *)(GPIOF | BSRR)) |= 0x01 << 10 | 0x01 << 9;
	...
	// PC 1, 2, 6, 7 switch
    *((V_UINT32 *)(GPIOC | MODER)) |= ~(0x03 << 2 * 1) | ~(0x03 << 2 * 2) | ~(0x03 << 2 * 6) | ~(0x03 << 2 * 7);
    *((V_UINT32 *)(GPIOC | OSPEEDR)) &= ~(0x03 << 2 * 1) | ~(0x03 << 2 * 2) | ~(0x03 << 2 * 6) | ~(0x03 << 2 * 7);
    *((V_UINT32 *)(GPIOC | PUPDR)) &= ~(0x03 << 2 * 1) | ~(0x03 << 2 * 2) | ~(0x03 << 2 * 6) | ~(0x03 << 2 * 7);
